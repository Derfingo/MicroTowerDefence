...
[CustomEditor(typeof(BindingKey))]
    public class BindingKeyEditor : Editor
    {
        ...
        {
            m_ActionProperty = serializedObject.FindProperty("_inputActionMap");
            m_BindingIdProperty = serializedObject.FindProperty("_bindingId");
            m_ActionLabelProperty = serializedObject.FindProperty("_rebindNameText");
            m_BindingTextProperty = serializedObject.FindProperty("_bindingButtonText");
            m_RebindOverlayProperty = serializedObject.FindProperty("_rebindingOverlayView");
            m_RebindTextProperty = serializedObject.FindProperty("_rebindingOverlayText");
            ...
            m_DisplayStringOptionsProperty = serializedObject.FindProperty("_displayStringOptions");
